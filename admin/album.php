...
<head>
    ...
    <style>
        body {
            background: url('../path/to/your/background.jpg') no-repeat center center fixed; /* Ganti dengan path gambar background Anda */
            background-size: cover; /* Membuat background menutupi seluruh halaman */
            color: pink; /* Mengubah warna teks jika perlu */
        }
        .navbar {
...
<body>
    ...
    <footer class="d-flex justify-content-center border-top mt-3 footer">
    </footer>
